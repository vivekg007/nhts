  ...
  void loadBatchDetails(String batchNo) async {
    ...
    for (int i = 0; i < batchList.length; i++) {
      ...
      setState(() {
        ...
        noofBagss = noBags;
        weightKg = grossWt;
        numofbagsController.text = noBags;
        totalwghtController.text = grossWt;
      });
    }
  }
...
*/
      ...
      // listings
      //     .add(txt_label_mandatory("availstock", Colors.black, 14.0, false));
      ...
      if (TrnsferprocssList.length > 0) {
        for (int i = 0; i < TrnsferprocssList.length; i++) {
          int saveprocesstransfer = await db.transferprocessList(
              ...
              buyingCenter: TrnsferprocssList[i].buyingCenter,
              totBagTransfer: '',
              totWeightTransfer: '');
